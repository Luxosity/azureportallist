  ...
  [514, 204],
  {
    9963: (e, t, n) => {
        ...
        return a.createElement(
          "button",
          {
            ...
            className: (0, l.Z)(
              ...
              S.collapseSidebarButton
            ),
            onClick: t,
          },
          a.createElement(C, { className: S.collapseSidebarButtonIcon })
        );
      }
      var N = n(9689),
        x = n(902);
      ...
      function B(e) {
        ...
        return a.createElement(Z.Provider, { value: o }, t);
      }
      var y = n(6043),
        w = n(8596),
        L = n(9960),
      ...
      function F(e) {
        ...
        const { items: m, label: u, collapsible: b, className: p, href: h } = t,
          ...
          v = (0, i._F)(t, o),
          k = (0, w.Mg)(h, o),
          { collapsed: C, setCollapsed: S } = (0, y.u)({
            initialState: () => !!b && !v && t.collapsed,
          }),
          { expandedItem: I, setExpandedItem: N } = (function () {
            const e = (0, a.useContext)(Z);
            if (e === T) throw new x.i6("DocSidebarItemsExpandedStateProvider");
            return e;
          })(),
          B = function (e) {
            void 0 === e && (e = !C), N(e ? null : s), S(e);
          };
        return (
          (function (e) {
          ...
          })({ isActive: v, collapsed: C, updateCollapsed: B }),
          (0, a.useEffect)(() => {
            b && null != I && I !== s && E && S(!0);
          }, [b, I, s, S, E]),
          a.createElement(
      ...
      var H = n(3919),
        P = n(9471);
      const W = { menuExternalLink: "menuExternalLink_NmtK" };
      function D(e) {
        let {
          item: t,
          onItemClick: n,
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            (0, _.Z)(
              {
                className: (0, l.Z)("menu__link", !E && W.menuExternalLink, {
                  "menu__link--active": h,
                }),
                autoAddBaseUrl: p,
      ...
      const z = { menuHtmlItem: "menuHtmlItem_M9Kj" };
      function R(e) {
        ...
        return a.createElement("li", {
          className: (0, l.Z)(
            ...
            i && [z.menuHtmlItem, "menu__list-item"],
            s
          ),
          key: o,
      ...
      function U(e) {
        ...
        switch (t.type) {
          case "category":
            return a.createElement(F, (0, _.Z)({ item: t }, n));
          case "html":
            return a.createElement(R, (0, _.Z)({ item: t }, n));
          default:
            return a.createElement(D, (0, _.Z)({ item: t }, n));
        }
      }
      function q(e) {
        let { items: t, ...n } = e;
        return a.createElement(
          ...
          null,
          t.map((e, t) =>
            a.createElement(U, (0, _.Z)({ key: t, item: e, index: t }, n))
          )
        );
      }
      const V = (0, a.memo)(q),
      ...
      function j(e) {
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(V, { items: n, activePath: t, level: 1 })
          )
        );
      }
      const G = "sidebar_njMd",
        Y = "sidebarWithHideableNavbar_wUlq",
        O = "sidebarHidden_VK0M",
        X = "sidebarLogo_isFc";
      function J(e) {
        ...
        return a.createElement(
          "div",
          { className: (0, l.Z)(G, c && Y, r && O) },
          c && a.createElement(k.Z, { tabIndex: -1, className: X }),
          a.createElement(j, { path: t, sidebar: n }),
          i && a.createElement(I, { onClick: o })
        );
      }
      const Q = a.memo(J);
      var $ = n(3102),
      ...
      function le(e) {
        ...
        return a.createElement(
          a.Fragment,
          null,
          n && a.createElement(Q, e),
          l && a.createElement(ae, e)
        );
      }
      const oe = {
      ...
      function se(e) {
        ...
        return a.createElement(
          "aside",
          {
            ...
            onTransitionEnd: (e) => {
              e.currentTarget.classList.contains(ce.docSidebarContainer) &&
                n &&
                s(!0);
            },
          },
      ...
      function me(e) {
        ...
        return a.createElement(
          "main",
          {
            className: (0, l.Z)(
              de.docMainContainer,
              (t || !o) && de.docMainContainerEnhanced
            ),
          },
          a.createElement(
            "div",
      ...
      const ue = { docPage: "docPage__5DB", docsWrapper: "docsWrapper_BCFX" };
      function be(e) {
        let { children: t } = e;
        const n = (0, d.V)(),
          [l, o] = (0, a.useState)(!1);
              ...
              a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement("b", null, "itjak.io"),
                    " ",
                    "you can use the ",
                    " ",
                    a.createElement(
